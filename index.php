...
$GLOBALS['config'] = array(
    ...
    "path" => array(
        ...
        "basePath" => "C:/wamp64/www/Movie_assign/"
    ),
    "default" => array(
        "controller" => "main",
        "method" => "index"
...
<head>
    ...
    <!--<script src="/Movie_assign/assets/js/bootstrap.js"></script>
    <script src="/Movie_assign/assets/js/jquery-3.1.1.min.js"></script>
 -->
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script src="https://www.google.com/recaptcha/api.js" async defer></script> <!--reCAPTCHA API JavaScript library-->

    <link href="/Movie_assign/assets/sass/main.css" type="text/css" rel="stylesheet">
    <link rel='stylesheet' type='text/css' href='/Movie_assign/assets/sass/css/contactform.css'>
